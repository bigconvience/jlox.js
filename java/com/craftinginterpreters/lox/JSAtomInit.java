...
public class JSAtomInit {
  ...
  static {
    ...
    js_atom_init.add("MapIterator");
    js_atom_init.add("SetIterator");
    js_atom_init.add("ArrayIterator");
    js_atom_init.add("StringIterator");
    js_atom_init.add("RegExpStringIterator");
