...
public class ShortOPCodeInfo {
  ...
  static {
    ...
    opcode_info.put(
      OP_invalid.ordinal(),
      new JSOpCode("invalid",1,0,0,none));
    opcode_info.put(
      OP_push_i32.ordinal(),
    ...
    opcode_info.put(
      OP_call_constructor.ordinal(),
      new JSOpCode("call_constructor",3,2,1,npop));
    opcode_info.put(
      OP_call.ordinal(),
    ...
    opcode_info.put(
      OP_tail_call_method.ordinal(),
      new JSOpCode("tail_call_method",3,2,0,npop));
    opcode_info.put(
    ...
    opcode_info.put(
      OP_check_ctor_return.ordinal(),
      new JSOpCode("check_ctor_return",1,1,2,none));
    opcode_info.put(
    ...
    opcode_info.put(
      OP_define_private_field.ordinal(),
      new JSOpCode("define_private_field",1,3,1,none));
    opcode_info.put(
    ...
    opcode_info.put(
      OP_get_super_value.ordinal(),
      new JSOpCode("get_super_value",1,3,1,none));
    opcode_info.put(
      OP_put_super_value.ordinal(),
      new JSOpCode("put_super_value",1,4,0,none));
    opcode_info.put(
    ...
    opcode_info.put(
      OP_set_name_computed.ordinal(),
      new JSOpCode("set_name_computed",1,2,2,none));
    opcode_info.put(
      OP_set_proto.ordinal(),
      new JSOpCode("set_proto",1,2,1,none));
    opcode_info.put(
      OP_set_home_object.ordinal(),
      new JSOpCode("set_home_object",1,2,2,none));
    opcode_info.put(
      OP_define_array_el.ordinal(),
      new JSOpCode("define_array_el",1,3,2,none));
    opcode_info.put(
      OP_append.ordinal(),
      new JSOpCode("append",1,3,2,none));
    opcode_info.put(
      OP_copy_data_properties.ordinal(),
      new JSOpCode("copy_data_properties",2,3,3,u8));
    opcode_info.put(
      OP_define_method.ordinal(),
      new JSOpCode("define_method",6,2,1,atom_u8));
    opcode_info.put(
      OP_define_method_computed.ordinal(),
      new JSOpCode("define_method_computed",2,3,1,u8));
    opcode_info.put(
    ...
    opcode_info.put(
      OP_set_loc_uninitialized.ordinal(),
      new JSOpCode("set_loc_uninitialized",3,0,0,loc));
    opcode_info.put(
    ...
    opcode_info.put(
      OP_get_var_ref_check.ordinal(),
      new JSOpCode("get_var_ref_check",3,0,1,var_ref));
    opcode_info.put(
      OP_put_var_ref_check.ordinal(),
      new JSOpCode("put_var_ref_check",3,1,0,var_ref));
    opcode_info.put(
      OP_put_var_ref_check_init.ordinal(),
      new JSOpCode("put_var_ref_check_init",3,1,0,var_ref));
    opcode_info.put(
    ...
    opcode_info.put(
      OP_with_delete_var.ordinal(),
      new JSOpCode("with_delete_var",10,1,0,atom_label_u8));
    opcode_info.put(
    ...
    opcode_info.put(
      OP_with_get_ref_undef.ordinal(),
      new JSOpCode("with_get_ref_undef",10,1,0,atom_label_u8));
    opcode_info.put(
    ...
    opcode_info.put(
      OP_make_var_ref_ref.ordinal(),
      new JSOpCode("make_var_ref_ref",7,0,2,atom_u16));
    opcode_info.put(
    ...
    opcode_info.put(
      OP_for_await_of_start.ordinal(),
      new JSOpCode("for_await_of_start",1,1,3,none));
    opcode_info.put(
    ...
    opcode_info.put(
      OP_for_await_of_next.ordinal(),
      new JSOpCode("for_await_of_next",1,3,4,none));
    opcode_info.put(
      OP_iterator_get_value_done.ordinal(),
      new JSOpCode("iterator_get_value_done",1,1,2,none));
    opcode_info.put(
      OP_iterator_close.ordinal(),
      new JSOpCode("iterator_close",1,3,0,none));
    opcode_info.put(
      OP_iterator_close_return.ordinal(),
      new JSOpCode("iterator_close_return",1,4,4,none));
    opcode_info.put(
      OP_async_iterator_close.ordinal(),
      new JSOpCode("async_iterator_close",1,3,2,none));
    opcode_info.put(
      OP_async_iterator_next.ordinal(),
      new JSOpCode("async_iterator_next",1,4,4,none));
    opcode_info.put(
      OP_async_iterator_get.ordinal(),
      new JSOpCode("async_iterator_get",2,4,5,u8));
    opcode_info.put(
    ...
    opcode_info.put(
      OP_async_yield_star.ordinal(),
      new JSOpCode("async_yield_star",1,1,2,none));
    opcode_info.put(
      OP_await.ordinal(),
    ...
    opcode_info.put(
      OP_is_undefined_or_null.ordinal(),
      new JSOpCode("is_undefined_or_null",1,1,1,none));
    opcode_info.put(
